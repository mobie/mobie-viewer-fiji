...
public class GridPositionSelector implements Runnable
{
	private BdvHandle bdvHandle;
	private boolean is2D;
	private Supplier< Collection< SegmentationDisplay > > segmentationDisplaySupplier;

	public GridPositionSelector( BdvHandle bdvHandle, boolean is2D, Supplier< Collection< SegmentationDisplay > > segmentationDisplaySupplier )
	{
