...
public class ViewsGithubWriter {
    ...
    private GitLocation viewsGitLocation;
    private BookmarkReader bookmarkReader;

    // ViewsGithubWriter( GitLocation bookmarkGitLocation, BookmarkReader bookmarkReader ) {
    //     this.viewsGitLocation = bookmarkGitLocation;
    ...
    //             new GitHubContentGetter( viewsGitLocation.repoUrl, viewsGitLocation.path, viewsGitLocation.branch, null );
    ...
    // }
    //
    // private BookmarkGithubWriter.FilePathAndSha getMatchingBookmarkFilePathAndSha () {
