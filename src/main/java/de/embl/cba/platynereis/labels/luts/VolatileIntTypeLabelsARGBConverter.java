 ...
 */
public class VolatileIntTypeLabelsARGBConverter implements Converter< AbstractIntegerType, VolatileARGBType >
{
	...
	@Override
	public void convert( final AbstractIntegerType input, final VolatileARGBType output ){
