...
class AgataOpenCellProfilerImageTableCmd
{
	public static void main( String[] args ) throws Exception
	{
		...
		cmd.labels = new String[]{"Cytoplasm=FileName_CytoplasmLabels","Nucleoplasm=FileName_NucleoplasmLabels","Nucleoli=FileName_NucleoliLabels","Speckles=FileName_SpecklesLabels"};
